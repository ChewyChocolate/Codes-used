package com.example.classificationofcrabs
...
class CrabClassifier(context: Context) {
    private val interpreter: Interpreter

    init {
        // Load tflite model from assets
        val fileDescriptor = context.assets.openFd("crab_efficientnetv2b0_1.tflite")
